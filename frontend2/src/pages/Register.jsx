    ...
    <div className="min-h-screen flex bg-slate-50 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://i.pinimg.com/736x/b8/67/63/b867632f8d04bf7778950b2fbe389fae.jpg')`, // 🔁 change this
          }}
        />
        {/* Optional Gradient Glow */}
        <div className="absolute inset-0 bg-gradient-to-br from-teal-400/20 to-black-500/20" />
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-black  overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <div className="relative group">
            {/* Strong Glow Ring (visible on white bg) */}
            <div className="absolute -inset-1.5 rounded-3xl bg-gradient-to-r from-indigo-500 via-blue-500 to-cyan-400 opacity-40 blur-lg group-hover:opacity-60 transition duration-500"></div>

            {/* Main Card */}
            <div className="relative bg-white lg:border lg:border-slate-200 lg:rounded-3xl lg:p-10 shadow-2xl shadow-indigo-500/20">
              ...
              {!credential ? (
                <div className="flex flex-col items-center justify-center py-6">
                  <p className="text-slate-500 font-medium mb-6">
                    Authenticate first to select your role
                  </p>
                ...
                <div className="animate-fade-in">
                  <div className="flex items-center gap-3 p-3 bg-indigo-50 border border-indigo-100 rounded-xl mb-8">
                    {googleData.picture && (
                      <img src={googleData.picture} alt="" className="w-8 h-8 rounded-full" />
                    )}
                    <div>
                ...
                ${role === r.value
                      ...
                      >
                        ...
                        <div className={`font-bold text-sm ${role === r.value ? 'text-indigo-900' : 'text-slate-700'}`}>
                          {r.label}
                        </div>
                        <div className={`text-xs font-medium mt-1 ${role === r.value ? 'text-indigo-600' : 'text-slate-500'}`}>
                          {r.subtitle}
                        </div>
                      </button>
                    ))}
