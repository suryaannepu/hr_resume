...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Navbar */}
      <nav className="border-b bg-white/5 border-white/10 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-extrabold text-white">RESUME AI</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              <button className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-400 to-blue-700 text-white font-semibold shadow-lg hover:scale-105 transition-all" onClick={() => navigate(user?.role === 'recruiter' ? '/recruiter-dashboard' : '/jobs')}>Go to Dashboard <ArrowRight className="w-4 h-4 inline ml-1" /></button>
            ) : (
              <>
                <button className="btn-ghost" onClick={() => navigate('/login')}>Sign In</button>
                <button className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-400 to-blue-700 text-white font-semibold shadow-lg hover:scale-105 transition-all" onClick={() => navigate('/register')}>Get Started Free</button>
              </>
            )}
          </div>
        </div>
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-black via-slate-900/90 to-black"></div>
        ...
        {/* Glow Effects */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(59,130,246,0.18),transparent_40%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(37,99,235,0.18),transparent_40%)]"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-10 pb-20">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            {/* LEFT CONTENT */}
            <div>
              <div className="font-[Poppins] inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-white text-sm font-semibold mb-8 backdrop-blur-md">
                <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
                Powered by 9 AI Agents
              </div>

              <h1 className="font-[ Montserrat] text-xl lg:text-5xl font-white text-white leading-tight mb-6">
                Every Resume{" "}
                <span className="text-transparent lg:text-7xl font-bold bg-clip-text bg-gradient-to-r from-blue-400 to-black-500">
                  Analyzed
                </span>
                <br />
                Every Candidate{" "}
              ...
              <p className="text-xl text-white/70 mb-10 max-w-xl">
                Let intelligent AI agents screen resumes, rank candidates, and conduct interviews —
                while you focus on hiring the best talent.
              </p>

              <div className="flex flex-wrap gap-4">
                <button
                  className="px-8 py-4 rounded-xl bg-gradient-to-r from-blue-400 to-blue-700 text-black font-bold hover:scale-105 transition shadow-lg"
                ...
                <button
                  className="px-8 py-4 rounded-xl bg-white/10 border border-white/20 backdrop-blur-md hover:bg-white/20 transition"
        ...
        <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl p-6 shadow-2xl relative">

          <div className="absolute -inset-1 bg-gradient-to-r from-green-400 to-blue-500 opacity-20 blur-xl rounded-2xl"></div>

          <div className="relative">
            <p className="text-sm text-white/60 mb-4">Live AI Activity</p>

            {["Resume Parsed", "Candidate Ranked", "Interview Scheduled"].map((item, i) => (
              <div key={i} className="flex justify-between items-center mb-3 bg-white/5 border border-white/10 p-3 rounded-lg">
            ...
            {/* <div className="hidden lg:block animate-fade-in-up">
              <div className="bg-white/60 border border-slate-200 rounded-2xl p-6 shadow-xl shadow-slate-200/50">
                ...
                <div className="bg-white/60 border border-slate-100 rounded-xl p-4 mb-4">
                  <p className="text-xs text-slate-500 mb-3 font-bold uppercase tracking-wider">Quick Actions</p>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white/60 rounded-lg p-4 text-center border border-slate-200 hover:border-blue-300 hover:shadow-md transition-all cursor-pointer">
                ...
                <div className="space-y-3 mt-6">
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between bg-white/60 rounded-lg p-3 border border-slate-200 shadow-sm">
                      <div className="flex items-center gap-3">
                        {item.icon}
            ...
            <div className="hidden lg:block animate-fade-in-up relative">

              {/* Glow background */}
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-blue-700 rounded-3xl blur-2xl opacity-20"></div>

              <div className="relative bg-white/10 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl">

                {/* Header */}
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-r from-blue-400 to-black-500 flex items-center justify-center text-white shadow-lg">
                    <Zap className="w-5 h-5" />
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-white">Welcome back, User!</p>
                    <p className="text-xs text-white/60">AI-Powered Recruiter • Active Hiring</p>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-4 mb-5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-white/5 rounded-xl p-4 text-center border border-white/10 hover:border-blue-400 hover:bg-white/10 hover:shadow-lg transition-all cursor-pointer">
                      <FileEdit className="w-6 h-6 text-blue-400 mx-auto mb-2" />
                      <p className="text-xs font-semibold text-white/80">Create Interview</p>
                    </div>

                    <div className="bg-white/5 rounded-xl p-4 text-center border border-white/10 hover:border-purple-400 hover:bg-white/10 hover:shadow-lg transition-all cursor-pointer">
                      <Mic className="w-6 h-6 text-purple-400 mx-auto mb-2" />
                      <p className="text-xs font-semibold text-white/80">Phone Screening</p>
                    </div>
                ...
                <div className="space-y-3 mt-4">
                  ...
                  {[
                    { role: 'Full Stack Developer', icon: <Monitor className="w-4 h-4 text-white/60" /> },
                    { role: 'UI/UX Designer', icon: <Palette className="w-4 h-4 text-white/60" /> },
                    { role: 'Data Engineer', icon: <BarChart className="w-4 h-4 text-white/60" /> }
                  ].map((item, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between bg-white/5 rounded-xl p-3 border border-white/10 hover:bg-white/10 hover:shadow-md transition-all"
                    >
                      <div className="flex items-center gap-3">
                        {item.icon}
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold text-blue-300 bg-blue-500/10 border border-blue-400/20 px-2.5 py-1 rounded-lg cursor-pointer hover:bg-blue-500/20 transition">
                          Send
                        </span>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[{ num: '9', label: 'AI Agents' }, { num: '<30s', label: 'Processing Time' }, { num: '100%', label: 'Automated' }, { num: '24/7', label: 'AI Interviews' }].map((s, i) => (
            <div key={i} className="text-center group">
              <div className="text-4xl font-black text-white mb-2">{s.num}</div>
              <div className="text-sm font-bold text-blue-400 uppercase tracking-wide">{s.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="workflow" className="max-w-7xl mx-auto px-6 py-16">
        <div className="max-w-7xl mx-auto bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-black text-white mb-4 tracking-tight">Streamline Your Hiring Process</h2>
            <p className="text-lg text-blue-600 max-w-2xl mx-auto font-medium">From job posting to AI interview — fully automated in 5 simple steps</p>
          </div>
          <div className="grid md:grid-cols-5 gap-6">
            {WORKFLOW_STEPS.map((step, i) => (
              <div key={i} className="relative group">
                <div className="bg-blue border border-slate-200 rounded-2xl p-6 shadow-sm text-center h-full hover:shadow-lg hover:-translate-y-2 transition-all duration-300">
                  <div className="flex justify-center mb-4 bg-blue-50 w-16 h-16 mx-auto rounded-full items-center">{step.icon}</div>
                  <div className="text-xs font-black tracking-widest text-white-600 mb-2">STEP {step.num}</div>
                  <h3 className="text-base font-bold text-blue-500 mb-2">{step.title}</h3>
                  <p className="text-sm text-slate-600 leading-relaxed font-medium">{step.desc}</p>
                </div>
                {i < WORKFLOW_STEPS.length - 1 && (
                  <div className="hidden md:flex absolute top-1/2 -right-10 transform -translate-y-1/2 z-20">
                    <div className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
      ...
      {/* AI Agent Showcase */}
      <section id="agents" className="  py-0 mb-16">
        <div className="max-w-7xl mx-auto bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md">
          <div className="max-w-7xl mx-auto px-6 py-24">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-black text-white mb-4 tracking-tight">Meet the AI Hiring Committee</h2>
              <p className="text-lg text-blue-600 max-w-2xl mx-auto font-medium">9 specialized agents work together to analyze every candidate from multiple angles</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {AGENTS_SHOWCASE.map((agent, i) => (
                <div key={i} className="bg-blue border border-slate-200 rounded-2xl p-6 shadow-sm group hover:shadow-lg hover:-translate-y-2 transition-all duration-300 flex flex-col justify-start">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="font-bold text-blue-500 text-lg">{agent.name}</h3>
                  </div>
                  <p className="text-sm text-slate-400 leading-relaxed font-medium">{agent.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-16">
        <div className="max-w-7xl mx-auto bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-black text-white mb-4 tracking-tight">FEATURES</h2>
            <p className="text-lg text-blue-600 max-w-2xl mx-auto font-medium">
              Everything you need to streamline AI-powered hiring
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-16 items-center ">

            <div className="p-8 rounded-3xl bg-blue border border-blue-100 shadow-sm">
              <h2 className="text-2xl font-black text-white mb-6 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center"><Shield className="w-5 h-5 text-blue-600" /></div>  For Recruiters
              </h2>
      ...
      {/* CTA */}
      <section className="bg-gradient-to-r from-blue-400 to-black-500 border-t border-slate-800 text-white rounded-t-[3rem] mx-4 lg:mx-12 mb-0 overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto px-6 py-24 text-center relative z-10">
          <h2 className="text-3xl lg:text-5xl font-black  text-slate-400 mb-6 tracking-tight">Ready to Transform Your Hiring?</h2>
      ...
      {/* Footer */}
      <footer className="bg-slate-5000 border-t border-slate-200 mt-0">
        <div className="max-w-7xl mx-auto px-6 py-8 text-center md:flex md:justify-between md:text-left items-center">
          <div>
            <div className="flex items-center gap-2 justify-center md:justify-start mb-2 md:mb-0">
              ...
              <span className="font-bold text-slate-90">RESUME AI</span>
            </div>
