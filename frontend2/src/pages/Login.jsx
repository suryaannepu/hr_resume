      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-black ">
        <div className="w-full max-w-md">
          ...
          <div className="relative group">
            {/* Glow Layer */}
            <div className="absolute -inset-1 rounded-3xl bg-blue-500  opacity-100 blur-xl group-hover:opacity-50 transition duration-500"></div>

            {/* Main Card */}
            <div className="relative bg-white lg:border lg:border-slate-200 lg:rounded-3xl lg:p-10 px-12 py-28 shadow-2xl shadow-blue-900/20">
